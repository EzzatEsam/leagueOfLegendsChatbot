...
from lol_chatter_backend.LolGeminiClient.chat_manager import ChatManager as GeminiChatManager
from lol_chatter_backend.LolGeminiClient.model_generation import get_model
...
async def get_chat_response(
    ...
    if msgs[-1].role == "model":
        return JSONResponse(status_code=200, content=ErrorDTO(message="Already responded").model_dump())
